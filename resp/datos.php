...
////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    <div id='informacion' class='informacion' style='display: none;'>
        ...
        <img id='logo' style='grid-column: 1 / 3; margin: auto;' src='images/banner-logo.png' alt='logo'>
            <div style='grid-column: 1 / 3; display: grid; grid-template-columns: 1fr 1fr;'>
                <div style='margin-left: 25%; display: inline;'><h4>Bachillerato:</h4>".$Espe."</div>
                <div style='margin-left: 25%; display: inline;'><h4>Año Lectivo:</h4>".$Peri."</div>
                <div style='margin-left: 25%; display: inline;'><h4>Curso:</h4>".$Curso."</div>
                <div style='margin-left: 25%; display: inline;'><h4>Fecha:</h4>".$Fecha."</div>
            </div>       
        </div>
    </div>
    <br><br>"; ///oculto para imprimir agregar datos

    $html.="<table id = 'tabla' style='margin: auto; width: 100%; border-spacing: 10px 5px;'>
                <thead>
                    <th style='width: 0%;'><center>No.</th>
                    ...
                    <th class='detalle'><center>Detalle</th>
                </thead>";
    $cont =0;
    ...
    {           
        ...
        $obs= round(($row3['CANTIDAD_R']/$row3['CANTIDAD_T'])*0.5,2);
    ...
    if($cont==0){
        echo "<p></p><img src='images/estamos-trabajando.png' style='width:25%;' alt='Estamos trabajando'><p style='font-size: 2em; font-weight: bold; color: #44A0D3;  text-align:center;'>¡Lo sentimos, No tenemos Resultados del elemento seleccionado!</p>";
    }else{
        $html.="";
        echo $html;
    } 
