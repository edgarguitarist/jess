...
<?php include "includes/header.php";?>
    <section id="container">
        ...
        <br>
            <h2>EVALUACIÓN DE DIRECTIVOS:</h2><br>
            <div class="datos">
                <div class="wd40">
                    ...
                    ?>
                    <select  name="sel_cur_dir" id="sel_cur_dir" class="select-css" required="">
                ...
                <div class="wd50">
                    ...
                    <select name="sel_doc_dir" id="sel_doc_dir" class="select-css" required="">
                    </select>
                </div>   
            </div>
